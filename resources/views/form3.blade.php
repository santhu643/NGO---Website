                        ...
                        <ul class="nav nav-tabs rounded-bottom" style="border-radius: 10px 10px 10px 10px; overflow: hidden;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="tab3" href="#step3" onclick="showStep(3)">
                                    <i class="fas fa-tractor"></i> Plantation Development <span id="icon3" class="text-danger">❌</span>
                                </a>
                            </li>
                            <li class="nav-item">
...
<div id="step2" style="display: none;">
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            <label class="form-label">Patta Number <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="pattaNumber" required>
        </div>
        <div class="col-md-4">
            <label class="form-label">Total Area (ha) <span class="text-danger">*</span></label>
            <input type="text" class="form-control" name="totalArea" required>
        </div>
        <div class="col-md-4">
            <label class="form-label">Revenue Village <span class="text-danger">*</span></label>
    ...
    <div class="col-md-12">
        ...
        <div class="ms-4">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="plantationMango" name="plantationType[]" value="Mango">
                <label class="form-check-label" for="plantationMango">Mango</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="plantationGuava" name="plantationType[]" value="Guava">
                <label class="form-check-label" for="plantationGuava">Guava</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="plantationLemon" name="plantationType[]" value="Lemon">
                <label class="form-check-label" for="plantationLemon">Lemon</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="plantationMoringa" name="plantationType[]" value="Moringa">
                <label class="form-check-label" for="plantationMoringa">Moringa</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="plantationOther" name="plantationType[]" value="Other">
                <label class="form-check-label" for="plantationOther">Other</label>
                <input type="text" class="form-control d-inline-block ms-2" style="width: 200px;" name="plantationOtherText" placeholder="Specify if other">
            </div>
        </div>
    </div>
</div>
