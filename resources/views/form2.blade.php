...
<div id="step3" style="display: none;">
    ...
    <div class="container p-3">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="sf_no" class="form-label">S.F. No. of the land to be developed <span class="text-danger">*</span></label>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <div class="d-flex gap-3">
                    <input type="radio" name="inspection" value="Associate"> Associate
                    <input type="radio" name="inspection" value="Professional"> Professional
                </div>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <div class="d-flex gap-3">
                    <input type="radio" name="approved_by" value="Coordinator"> Coordinator
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" id="length" name="length" oninput="calculateVolume()">
            </div>
            <div class="col-md-4">
                <label for="breadth" class="form-label">Breadth in m</label>
                <input type="number" class="form-control" id="breadth" name="breadth" oninput="calculateVolume()">
            </div>
            <div class="col-md-4">
                <label for="depth" class="form-label">Depth in m</label>
                <input type="number" class="form-control" id="depth" name="depth" oninput="calculateVolume()">
            </div>
        </div>

        <div class="row mb-3">
            <div class="col-md-6">
                <label for="volume" class="form-label">Volume of Excavation (m³)</label>
                <input type="text" class="form-control" id="volume" name="volume" readonly>
            </div>
        </div>

        <!-- Continuing Remaining Fields -->
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="pradanContribution" name="pradanContribution" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="farmerContribution" name="farmerContribution" required>
            </div>
        </div>
